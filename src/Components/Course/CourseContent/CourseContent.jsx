...
const CourseContent = () => {
    return (
        <div className="">
           ...
           <p className="mt-4 font-dmsnas text-xl">This course distills wisdom from the Bhagavad Gita into four major themes. It covers mastering thoughts and emotions for inner peace (Mind Control), setting realistic goals and maintaining life balance (Managing Expectations), resolving conflicts with empathy and ethical principles (Conflict Resolution), and managing negative feelings while cultivating positivity t eos repellat minus nihil consectetur. Odio, nobis.</p>
            <p className="mt-4 font-dmsnas text-xl ">t, consectetur adipisicing elit. Neque exercitationem ea repellat laborum repellendus laudantium earum, dolore perferendis, odio nihil asperiores voluptatibus s repellat minus nihil consectetur. Odio, nobis. Deserunt blanditiis amet consequatur quod? Corporis nemo, at </p>

            <p className="mt-4 font-dmsnas text-xl ">
